...
public class Ambulances_ADD {
  ...
  private static int[][] victims = new int[300][3];
  ...
  private static void readFile() throws FileNotFoundException {
    ...
    while (scan.hasNext() && !(line = scan.nextLine()).isEmpty()) {
      ...
      victims[i][0] = Integer.parseInt(pers_coord[0]);
      victims[i][1] = Integer.parseInt(pers_coord[1]);
      victims[i][2] = Integer.parseInt(pers_coord[2]);
